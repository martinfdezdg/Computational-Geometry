...
'''
workpath = "/Users/martin/Documents/Estudios/Matemáticas e ingeniería informática/2021-2022/GCOM/Laboratorio/P1"
os.getcwd()
#os.chdir(workpath)
...
"""
OJO CON LA MULTPLICACIÓN DE LISTAS
"""
# -1*[1,2]
# [-1,-1]*[1,2]
a = [-1,-1]
...
print([a0*b0 for a0,b0 in zip(a,b)])
